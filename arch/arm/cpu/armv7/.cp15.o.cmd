cmd_arch/arm/cpu/armv7/cp15.o := /home/ennis/project/imx6slevk/fsl-linaro-toolchain-master/bin/arm-fsl-linux-gnueabi-gcc -Wp,-MD,arch/arm/cpu/armv7/.cp15.o.d  -nostdinc -isystem /home/ennis/project/imx6slevk/fsl-linaro-toolchain-master/bin/../lib/gcc/arm-fsl-linux-gnueabi/4.6.2/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x87800000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(cp15)"  -D"KBUILD_MODNAME=KBUILD_STR(cp15)" -c -o arch/arm/cpu/armv7/cp15.o arch/arm/cpu/armv7/cp15.c
